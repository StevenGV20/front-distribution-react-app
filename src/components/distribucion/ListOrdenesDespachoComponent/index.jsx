...
const ListOrdenesDespachoComponent = ({
  ...
  const isLoadCarga = (orden) => {
    return (
      orden.odc_peso > 0 && orden.odc_ubigeo/*  > 0 && orden.odc_volumen > 0 && orden.odc_imptot > 0 */
    );
  };
          ...
          {!loadingTable ? (
            ...
            ordenesDespacho.map((orden) => (
              ...
              >
                ...
                {showGrupo && !titlePage.match(GGUIA_REMISION_REMITENTE_PAGE.titlePage) && (
                ...
                <td className="col-span-5">
                  <div className="td-group-mobile">
                    <div className="w-full text-left">
                      <div
                        className={`rounded-md px-2 font-semibold tracking-widest text-white text-sm w-24 text-center ${
                          !isLoadCarga(orden)
                            ? "bg-red"
                            : !orden.gru_grucod
                            ? "bg-yellow-500"
                  ...
                  {titlePage.match(GGUIA_REMISION_REMITENTE_PAGE.titlePage) && (
                    <>
                      <div className="td-group">
                        ...
                        <div className=" text-left">{orden.grc_numdoc} </div>
                      </div>
                      <div className="td-group">
                        <div className="font-semibold text-left">
                          {orden.utr_plautr}
                        </div>
                        <div className=" text-left">{orden.cho_nombre} </div>
                      </div>
                    </>
                  )}
                </td>
                <td className="col-span-1 grid content-center">
                  {!orden.gru_grucod && (
                    <div className="space-y-3">
                      ...
                      <div>
                        {titlePage.match(PAGE_AGRUPAR_OD) && (
                          <div className="td-group bg-transparent text-center">
                            <div className="z-10">
                              <>
                                {((orden.odc_estado === "2" &&
                                  orden.odc_selusu === userLocal) ||
